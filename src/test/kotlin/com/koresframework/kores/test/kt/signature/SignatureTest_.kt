...
class SignatureTest_ {
    ...
    fun test() {
        ...
        assertEquals("(Ljava/lang/reflect/Type;Ljava/lang/Object;Lcom/koresframework/kores/test/kt/signature/Magic;)Lcom/koresframework/kores/test/kt/signature/Magic;", parametersAndReturnToInferredDesc(lazy { type }, method, method.parameters, method.returnType))

        //
        assertEquals("<T:Ljava/lang/Object;M::Lcom/koresframework/kores/test/kt/signature/Magic<TT;TM;>;>(Ljava/lang/reflect/Type;TT;TM;)TM;", method.methodClassfileGenericSignature())
    }

    companion object {
        fun <T, M: Magic<T, M>> apply(type: Type, data: T, m: M): M =
            STUB("apply")
    }
...
fun interface Magic<T, M: Magic<T, M>> {
    fun apply(data: T)
}