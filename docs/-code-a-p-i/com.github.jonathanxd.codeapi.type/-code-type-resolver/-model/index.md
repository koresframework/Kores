...
`class Model : `[`CommonResolver`](../-common-resolver/index.md)`<TypeElement?>`
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `Model(elements: Elements)`<br>Resolver that resolves [CodeType](../../-code-type/index.md) to Javax Model [TypeElement](#), or to `null` if type cannot be found. |
...
| Name | Summary |
|---|---|
| [resolve](resolve.md) | `fun resolve(type: Type): Either<`[`Exception`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-exception/index.html)`, out TypeElement>`<br>Resolves [type](resolve.md#com.github.jonathanxd.codeapi.type.CodeTypeResolver.Model$resolve(java.lang.reflect.Type)/type) to [T](#) |
