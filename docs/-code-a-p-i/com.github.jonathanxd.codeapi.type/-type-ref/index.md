[CodeAPI](../../index.md) / [com.github.jonathanxd.codeapi.type](../index.md) / [TypeRef](.)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `TypeRef(specifiedName: String)`<br>`TypeRef(outerType: `[`Type`](http://docs.oracle.com/javase/6/docs/api/java/lang/reflect/Type.html)`?, specifiedName: String)`<br>`TypeRef(specifiedName: String, isInterface: Boolean)``TypeRef(outerType: `[`Type`](http://docs.oracle.com/javase/6/docs/api/java/lang/reflect/Type.html)`?, specifiedName: String, isInterface: Boolean)`<br>Reference to a type, this is only intended to be used to inform outer types. |
