...
| [EnumEntry](../-enum-entry/index.md) | `data class EnumEntry : `[`ArgumentsHolder`](../-arguments-holder/index.md)`, Named, `[`ElementsHolder`](../-elements-holder/index.md)<br>Enumeration entry. |
