...
| Name | Summary |
|---|---|
| [withReturnType](with-return-type.md) | `abstract fun withReturnType(value: `[`Type`](http://docs.oracle.com/javase/6/docs/api/java/lang/reflect/Type.html)`): S`<br>See [T.returnType](../return-type.md) |
