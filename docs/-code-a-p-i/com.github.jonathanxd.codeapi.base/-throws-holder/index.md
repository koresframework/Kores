...
| Name | Summary |
|---|---|
| [throwsClause](throws-clause.md) | `abstract val throwsClause: List<`[`Type`](http://docs.oracle.com/javase/6/docs/api/java/lang/reflect/Type.html)`>`<br>Throws exception |
