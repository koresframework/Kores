...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `EnumValue(enumType: Type, enumEntry: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)`<br>Enum value. |

### Properties

| Name | Summary |
|---|---|
| [enumEntry](enum-entry.md) | `val enumEntry: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>Entry of enum. |
| [enumType](enum-type.md) | `val enumType: Type`<br>Type of enum |
