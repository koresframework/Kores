...
| Name | Summary |
|---|---|
| [withParameters](with-parameters.md) | `abstract fun withParameters(value: List<`[`CodeParameter`](../../-code-parameter/index.md)`>): S`<br>`open fun withParameters(vararg values: `[`CodeParameter`](../../-code-parameter/index.md)`): S`<br>See [T.parameters](../parameters.md) |
