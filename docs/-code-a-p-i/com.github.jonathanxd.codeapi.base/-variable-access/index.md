...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `VariableAccess(variableType: Type, name: `[`String`](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)`)`<br>Access to a variable in local scope. |
