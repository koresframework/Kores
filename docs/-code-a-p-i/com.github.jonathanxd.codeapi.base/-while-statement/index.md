...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `WhileStatement(type: `[`Type`](-type/index.md)`, expressions: List<`[`CodeInstruction`](../../com.github.jonathanxd.codeapi/-code-instruction.md)`>, body: `[`CodeSource`](../../com.github.jonathanxd.codeapi/-code-source/index.md)`)`<br>While statement |
...
| [expressions](expressions.md) | `val expressions: List<`[`CodeInstruction`](../../com.github.jonathanxd.codeapi/-code-instruction.md)`>`<br>Expression to check to start and/or continue the loop. |
