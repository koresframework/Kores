[CodeAPI](../../index.md) / [com.github.jonathanxd.codeapi.base](../index.md) / [ScopeAccess](.)

# ScopeAccess

`class ScopeAccess : `[`CodeInstruction`](../../com.github.jonathanxd.codeapi/-code-instruction.md)
...
| Name | Summary |
|---|---|
| [&lt;init&gt;](-init-.md) | `ScopeAccess(type: Type, scope: `[`Scope`](../-scope/index.md)`)`<br>Access to an inner or outer scope. |

### Properties

| Name | Summary |
|---|---|
| [scope](scope.md) | `val scope: `[`Scope`](../-scope/index.md) |
...
| Name | Summary |
|---|---|
| [outer](outer.md) | `fun outer(type: Type): ScopeAccess` |
