...
| [typeOrNull](../../com.github.jonathanxd.codeapi/type-or-null.md) | `val `[`CodePart`](../../com.github.jonathanxd.codeapi/-code-part/index.md)`.typeOrNull: Type?`<br>Gets the type of [CodePart](../../com.github.jonathanxd.codeapi/-code-part/index.md) or null if receiver is not a Typed instance. |
...
| [DynamicMethodSpec](../../com.github.jonathanxd.codeapi.common/-dynamic-method-spec/index.md) | `data class DynamicMethodSpec : Typed, `[`Named`](../-named/index.md)`, `[`ArgumentsHolder`](../-arguments-holder/index.md) |
