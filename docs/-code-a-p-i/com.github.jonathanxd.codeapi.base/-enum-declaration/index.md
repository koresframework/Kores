[CodeAPI](../../index.md) / [com.github.jonathanxd.codeapi.base](../index.md) / [EnumDeclaration](.)

# EnumDeclaration

`data class EnumDeclaration : `[`TypeDeclaration`](../-type-declaration/index.md)`, `[`ImplementationHolder`](../-implementation-holder/index.md)`, `[`EntryHolder`](../-entry-holder/index.md)
...
| [entries](entries.md) | `val entries: List<`[`EnumEntry`](../-enum-entry/index.md)`>`<br>Enum entries. |
