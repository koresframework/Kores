...
Example: for `S extends List<String>`, it will return `List` (obs: the [GenericType.resolvedType](../com.github.jonathanxd.codeapi.type/-generic-type/resolved-type.md) of `S extends List<String>` is `List<String>`.
