...
| Name | Summary |
|---|---|
| [arrayBaseComponent](index.md#-369784422%2FProperties%2F-1216412040) | [jvm]<br>open override val [arrayBaseComponent](index.md#-369784422%2FProperties%2F-1216412040): [KoresType](../-kores-type/index.md)<br>Array base component. |
| [arrayComponent](index.md#-337959063%2FProperties%2F-1216412040) | [jvm]<br>open override val [arrayComponent](index.md#-337959063%2FProperties%2F-1216412040): [KoresType](../-kores-type/index.md)<br>Array component. |
| [arrayDimension](index.md#256634656%2FProperties%2F-1216412040) | [jvm]<br>open override val [arrayDimension](index.md#256634656%2FProperties%2F-1216412040): [Int](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-int/index.html)<br>Array dimension, 0 if this type is not an array. |
| [binaryName](index.md#1472357601%2FProperties%2F-1216412040) | [jvm]<br>open val [binaryName](index.md#1472357601%2FProperties%2F-1216412040): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>Binary name of the class. |
| [bindedDefaultResolver](index.md#-773311966%2FProperties%2F-1216412040) | [jvm]<br>open val [bindedDefaultResolver](index.md#-773311966%2FProperties%2F-1216412040): [BindedTypeResolver](../-binded-type-resolver/index.md)<*><br>Creates a new binded default resolver instance. |
...
| [defaultResolver](index.md#-2059016090%2FProperties%2F-1216412040) | [jvm]<br>open override val [defaultResolver](index.md#-2059016090%2FProperties%2F-1216412040): [KoresTypeResolver](../-kores-type-resolver/index.md)<*><br>Default resolver. |
| [identification](index.md#474757855%2FProperties%2F-1216412040) | [jvm]<br>open override val [identification](index.md#474757855%2FProperties%2F-1216412040): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>Unique string identification, this property may be used for equality comparison, normal types, array types and generic types have different identifications, if a generic type represent a single [KoresType](../-kores-type/index.md) without any bound, then the identification will be the same as the single [KoresType](../-kores-type/index.md). |
| [interfaces](index.md#-1573442445%2FProperties%2F-1216412040) | [jvm]<br>open val [interfaces](index.md#-1573442445%2FProperties%2F-1216412040): [List](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin.collections/-list/index.html)<[Type](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Type.html)><br>Gets the super interfaces of this[Type](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Type.html) using default resolver. |
| [internalName](index.md#-848445531%2FProperties%2F-1216412040) | [jvm]<br>open val [internalName](index.md#-848445531%2FProperties%2F-1216412040): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)<br>Internal class name. |
...
| [isWildcard](index.md#1924686057%2FProperties%2F-1216412040) | [jvm]<br>open val [isWildcard](index.md#1924686057%2FProperties%2F-1216412040): [Boolean](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-boolean/index.html)<br>True if this is a wildcard generic type. |
...
| [superType](index.md#1114758200%2FProperties%2F-1216412040) | [jvm]<br>open val [superType](index.md#1114758200%2FProperties%2F-1216412040): [Type](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Type.html)?<br>Gets the super type of this[Type](https://docs.oracle.com/javase/8/docs/api/java/lang/reflect/Type.html) using default resolver. |
...
| [wrapped](index.md#-510634232%2FProperties%2F-1216412040) | [jvm]<br>open override val [wrapped](index.md#-510634232%2FProperties%2F-1216412040): [KoresType](../-kores-type/index.md)<br>Wrapped code type. |
